...
<html>
   ...
   //        			    <div class=\"user-text clear-both\">
		...
		<script src="../assets/js/util.js"></script>
			...
			<?php if (isset($tracknum) && (!isset($result) || !$result || !$trackingIDValid)) {echo "<script type=\"text/javascript\">setTimeout(function(){notify(\"您所查找的运单号不存在\", \"notify-red\")}, 200)</script>";} ?>
	</body>
</html>